    ...
    <div class="bg-white py-12 sm:py-12">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <button class="col-span-2 max-h-24 lg:col-span-1" id="${MusicSiteName.melon}"><img class="w-full object-contain rounded-lg" src="./src/styles/images/${MusicSiteName.melon}.png" alt="${MusicSiteName.melon}" width="158" height="48"></button>
          <button class="col-span-2 max-h-24 lg:col-span-1" id="${MusicSiteName.genie}"><img class="w-full object-contain rounded-lg" src="./src/styles/images/${MusicSiteName.genie}.jpg" alt="${MusicSiteName.genie}" width="158" height="48"></button>
          ...
          <button class="col-span-2 max-h-24 lg:col-span-1 sm:col-start-2 " id="${MusicSiteName.vibe}"> <img class="w-full object-contain rounded-lg" src="./src/styles/images/${MusicSiteName.vibe}.jpg" alt="${MusicSiteName.vibe}" width="158" height="48"></button>
          <button class="col-span-2 max-h-24 lg:col-span-1 sm:col-start-auto col-start-2" id="${MusicSiteName.bugs}"> <img class="w-full object-contain rounded-lg" src="./src/styles/images/${MusicSiteName.bugs}.jpg" alt="${MusicSiteName.bugs}" width="158" height="48"></button>
        </div>
      </div>
    </div>   
    `;
